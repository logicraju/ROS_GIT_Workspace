...
(cl:defmethod cl:initialize-instance :after ((m <calc_service-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'calc_service-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment-srv:<calc_service-request> is deprecated: use assignment-srv:calc_service-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <calc_service-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment-srv:num1-val is deprecated.  Use assignment-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <calc_service-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment-srv:num2-val is deprecated.  Use assignment-srv:num2 instead.")
  (num2 m))

(cl:ensure-generic-function 'operator_id-val :lambda-list '(m))
(cl:defmethod operator_id-val ((m <calc_service-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment-srv:operator_id-val is deprecated.  Use assignment-srv:operator_id instead.")
  (operator_id m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <calc_service-request>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'num2))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let* ((signed (cl:slot-value msg 'operator_id)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <calc_service-request>) istream)
  "Deserializes a message object of type '<calc_service-request>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'operator_id) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<calc_service-request>)))
  ...
  "assignment/calc_serviceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'calc_service-request)))
  "Returns string type for a service object of type 'calc_service-request"
  "assignment/calc_serviceRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<calc_service-request>)))
  ...
  "28b1b2ea728b368b3d6cf927afcd1305")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'calc_service-request)))
  "Returns md5sum for a message object of type 'calc_service-request"
  "28b1b2ea728b368b3d6cf927afcd1305")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<calc_service-request>)))
  ...
  (cl:format cl:nil "float64 num1~%float64 num2~%int64 operator_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'calc_service-request)))
  "Returns full string definition for message of type 'calc_service-request"
  (cl:format cl:nil "float64 num1~%float64 num2~%int64 operator_id~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <calc_service-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'calc_service-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment-srv:<calc_service-response> is deprecated: use assignment-srv:calc_service-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <calc_service-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment-srv:result-val is deprecated.  Use assignment-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<calc_service-response>)))
  ...
  "assignment/calc_serviceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'calc_service-response)))
  "Returns string type for a service object of type 'calc_service-response"
  "assignment/calc_serviceResponse")
